    ...
    const char *key)
{
    ...
    else if (strcmp(key, "tiling") == 0)
    {
        ...
        print_help_section(
            ...
            "  4. Multiplies the Pass 1 posterior by the match scores. If the fused argmax differs from the Pass 1 assignment, overrides it.\n"
            "\n"
            "  JTF never overrides a newly created cluster (Pass 1 produced a new anchor). It only refines existing-cluster assignments.\n"
            "\n"
            ...
            "  - Match scores: cluster 2 gets high weight, cluster 5 gets near-zero.\n"
            "  - After fusing with the Pass 1 posterior, cluster 2 wins.\n"
