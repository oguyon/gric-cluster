 ...
 */
static inline __attribute__((always_inline)) void calc_dist4_d64_core(
    const double *restrict q,
    const double *restrict a0,
    const double *restrict a1,
    const double *restrict a2,
    const double *restrict a3,
    double *restrict       out_dists,
    long                   size)
{
    double sum0 = 0.0;
...
/**
 * calc_dist8_d64_core() - Vectorized 1-query vs 8-anchor Euclidean distance (double).
 * @q:         Pointer to query array.
 * @a0:        Candidate anchor 0.
 * @a1:        Candidate anchor 1.
 * @a2:        Candidate anchor 2.
 * @a3:        Candidate anchor 3.
 * @a4:        Candidate anchor 4.
 * @a5:        Candidate anchor 5.
 * @a6:        Candidate anchor 6.
 * @a7:        Candidate anchor 7.
 * @out_dists: Array of 8 doubles to receive computed distances.
 * @size:      Number of elements in each array.
 */
static inline __attribute__((always_inline)) void calc_dist8_d64_core(
    const double *restrict q,
    const double *restrict a0,
    const double *restrict a1,
    const double *restrict a2,
    const double *restrict a3,
    const double *restrict a4,
    const double *restrict a5,
    const double *restrict a6,
    const double *restrict a7,
    double *restrict       out_dists,
    long                   size)
{
#if defined(__AVX__) && \
    ...
    if (size >= 8)
    {
        ...
        for (; i <= size - 8; i += 8)
        {
            ...
            __m256d d1_0 = _mm256_sub_pd(vq0, _mm256_loadu_pd(&a1[i]));
#ifdef __FMA__
            acc0 = _mm256_fmadd_pd(d0_0, d0_0, acc0);
            acc1 = _mm256_fmadd_pd(d1_0, d1_0, acc1);
#else
            acc0 = _mm256_add_pd(acc0, _mm256_mul_pd(d0_0, d0_0));
            acc1 = _mm256_add_pd(acc1, _mm256_mul_pd(d1_0, d1_0));
#endif
            __m256d d2_0 = _mm256_sub_pd(vq0, _mm256_loadu_pd(&a2[i]));
            __m256d d3_0 = _mm256_sub_pd(vq0, _mm256_loadu_pd(&a3[i]));
#ifdef __FMA__
            acc2 = _mm256_fmadd_pd(d2_0, d2_0, acc2);
            acc3 = _mm256_fmadd_pd(d3_0, d3_0, acc3);
#else
            acc2 = _mm256_add_pd(acc2, _mm256_mul_pd(d2_0, d2_0));
            acc3 = _mm256_add_pd(acc3, _mm256_mul_pd(d3_0, d3_0));
#endif
            __m256d d4_0 = _mm256_sub_pd(vq0, _mm256_loadu_pd(&a4[i]));
            __m256d d5_0 = _mm256_sub_pd(vq0, _mm256_loadu_pd(&a5[i]));
#ifdef __FMA__
            acc4 = _mm256_fmadd_pd(d4_0, d4_0, acc4);
            acc5 = _mm256_fmadd_pd(d5_0, d5_0, acc5);
#else
            acc4 = _mm256_add_pd(acc4, _mm256_mul_pd(d4_0, d4_0));
            acc5 = _mm256_add_pd(acc5, _mm256_mul_pd(d5_0, d5_0));
#endif
            __m256d d6_0 = _mm256_sub_pd(vq0, _mm256_loadu_pd(&a6[i]));
            __m256d d7_0 = _mm256_sub_pd(vq0, _mm256_loadu_pd(&a7[i]));
#ifdef __FMA__
            acc6 = _mm256_fmadd_pd(d6_0, d6_0, acc6);
            acc7 = _mm256_fmadd_pd(d7_0, d7_0, acc7);
#else
            acc6 = _mm256_add_pd(acc6, _mm256_mul_pd(d6_0, d6_0));
            acc7 = _mm256_add_pd(acc7, _mm256_mul_pd(d7_0, d7_0));
#endif
            ...
            __m256d d1_1 = _mm256_sub_pd(vq1, _mm256_loadu_pd(&a1[i + 4]));
#ifdef __FMA__
            acc0 = _mm256_fmadd_pd(d0_1, d0_1, acc0);
            acc1 = _mm256_fmadd_pd(d1_1, d1_1, acc1);
#else
            acc0 = _mm256_add_pd(acc0, _mm256_mul_pd(d0_1, d0_1));
            acc1 = _mm256_add_pd(acc1, _mm256_mul_pd(d1_1, d1_1));
#endif
            __m256d d2_1 = _mm256_sub_pd(vq1, _mm256_loadu_pd(&a2[i + 4]));
            __m256d d3_1 = _mm256_sub_pd(vq1, _mm256_loadu_pd(&a3[i + 4]));
#ifdef __FMA__
            acc2 = _mm256_fmadd_pd(d2_1, d2_1, acc2);
            acc3 = _mm256_fmadd_pd(d3_1, d3_1, acc3);
#else
            acc2 = _mm256_add_pd(acc2, _mm256_mul_pd(d2_1, d2_1));
            acc3 = _mm256_add_pd(acc3, _mm256_mul_pd(d3_1, d3_1));
#endif
            __m256d d4_1 = _mm256_sub_pd(vq1, _mm256_loadu_pd(&a4[i + 4]));
            __m256d d5_1 = _mm256_sub_pd(vq1, _mm256_loadu_pd(&a5[i + 4]));
#ifdef __FMA__
            acc4 = _mm256_fmadd_pd(d4_1, d4_1, acc4);
            acc5 = _mm256_fmadd_pd(d5_1, d5_1, acc5);
#else
            acc4 = _mm256_add_pd(acc4, _mm256_mul_pd(d4_1, d4_1));
            acc5 = _mm256_add_pd(acc5, _mm256_mul_pd(d5_1, d5_1));
#endif
            __m256d d6_1 = _mm256_sub_pd(vq1, _mm256_loadu_pd(&a6[i + 4]));
            __m256d d7_1 = _mm256_sub_pd(vq1, _mm256_loadu_pd(&a7[i + 4]));
#ifdef __FMA__
            acc6 = _mm256_fmadd_pd(d6_1, d6_1, acc6);
            acc7 = _mm256_fmadd_pd(d7_1, d7_1, acc7);
#else
            acc6 = _mm256_add_pd(acc6, _mm256_mul_pd(d6_1, d6_1));
            acc7 = _mm256_add_pd(acc7, _mm256_mul_pd(d7_1, d7_1));
#endif
        } // for (; i <= size - 8; i += 8)
        ...
        sum0 += _mm_cvtsd_f64(s0) + _mm_cvtsd_f64(_mm_unpackhi_pd(s0, s0));
        sum1 += _mm_cvtsd_f64(s1) + _mm_cvtsd_f64(_mm_unpackhi_pd(s1, s1));
        sum2 += _mm_cvtsd_f64(s2) + _mm_cvtsd_f64(_mm_unpackhi_pd(s2, s2));
        sum3 += _mm_cvtsd_f64(s3) + _mm_cvtsd_f64(_mm_unpackhi_pd(s3, s3));
        sum4 += _mm_cvtsd_f64(s4) + _mm_cvtsd_f64(_mm_unpackhi_pd(s4, s4));
        sum5 += _mm_cvtsd_f64(s5) + _mm_cvtsd_f64(_mm_unpackhi_pd(s5, s5));
        sum6 += _mm_cvtsd_f64(s6) + _mm_cvtsd_f64(_mm_unpackhi_pd(s6, s6));
        sum7 += _mm_cvtsd_f64(s7) + _mm_cvtsd_f64(_mm_unpackhi_pd(s7, s7));
...
#endif
    calc_dist4_d64_core(q, a0, a1, a2, a3, out_dists, size);
    calc_dist4_d64_core(q, a4, a5, a6, a7, out_dists + 4, size);
}
